...
const viewportNodeMainCarousel = <HTMLElement>document.querySelector('.embla__viewport');
const viewportNodeThumbCarousel = <HTMLElement>document.querySelector('.embla-thumbs__viewport');
